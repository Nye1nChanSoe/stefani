      ...
      <div className="pt-[52px] space-y-[90px]">
        ...
        <div className="flex justify-between items-start gap-8">
          ...
          <div className="flex-1">
            ...
            />
            <Paragraph
              text="After finishing up the user flow, these are the wireframes screen designs that we’ve worked on."
              marginTop={24}
              marginBottom={24}
              letterSpacing={3.36}
            />
            <Paragraph
              text="In these wireframes, we include sign up form, home screen, token number screen, notes screen, review screen, and also review screen."
              marginBottom={32}
              letterSpacing={3.36}
            />
          </div>
